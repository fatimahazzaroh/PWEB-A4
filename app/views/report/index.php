            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="<?= BASEURL ?>/penitipan/updateStatus/<?= $penitipan['id'] ?>" method="post">
                                <select name="status">
                                    <option value="booked" <?= $penitipan['status'] == 'booked' ? 'selected' : '' ?>>Booked</option>
                                    <option value="process" <?= $penitipan['status'] == 'process' ? 'selected' : '' ?>>Process</option>
                                    <option value="done" <?= $penitipan['status'] == 'done' ? 'selected' : '' ?>>Done</option>
                                </select>
